...
description: An open-source parameterizable NPU generator with a full-stack, multi-target compilation stack.
summary: |
    It lets you produce complete acceleration systems for emerging deep learning models&nbsp;&mdash; convolutional networks, transformers&nbsp;&mdash; with minimal human intervention.

    My primary contribution has been the continued development of the compiler, originally written by Sean Kinzer.
    I packaged it with pip, implemented a greedy memory allocation strategy that cut the DRAM footprint substantially during execution, removed code bloat left over from stitching several projects together, and expanded layer support to accommodate more diverse models.
talks:
  - MICRO 2023, Toronto
  - HPCA 2024, Edinburgh
  - ASPLOS 2024, San Diego
  - ISCA 2024, Buenos Aires
...
{% include photo.liquid src="/assets/images/genesys_flow.jpg" alt="GeneSys workflow." caption="GeneSys workflow" %}
